...
population_flow_data <- system.file("example_apps/population_flows", "Data on the global flow of people_Version March2014.csv", package = "ggcircos")
population_flows <- read.csv(population_flow_data)
